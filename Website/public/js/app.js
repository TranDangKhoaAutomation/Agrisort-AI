(function () {
  ...
  var setupAppSidebar = function () {
    ...
    var setSidebarOpen = function (isOpen) {
      var shouldOpen = Boolean(isOpen) && mobileQuery.matches;
      shell.classList.toggle("is-sidebar-open", shouldOpen);
      document.documentElement.classList.toggle("app-sidebar-open", shouldOpen);
    ...
    var handoffScrollToPage = function (event) {
  ...
  var watched = document.body.classList.contains("app-layout")
    ? []
